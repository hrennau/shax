...
(:
 : namespaceTools.xqm - utility functions for namespace-related operations
 :
...
import module namespace pt="http://www.ttools.org/xquery-functions" at "_constants.xqm";
